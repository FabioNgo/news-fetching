...
public class TTSService {
    ...
    private static String ttsServiceUri = "https://southeastasia.tts.speech.microsoft.com/cognitiveservices/v1";
    ...
    public static byte[] Synthesize(String textToSynthesize, String outputFormat, String locale, String genderName, String voiceName) throws Exception {
    	...
    	Authentication auth = new Authentication("09979708d7a2436db24df5bb14ed6435");
        ...
        webRequest.setReadTimeout(150000);
